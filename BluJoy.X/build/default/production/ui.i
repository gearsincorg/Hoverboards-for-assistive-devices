...
void runUI(void) {
    ...
    switch (uiState) {
        ...
        case 2:
            if (USER1_pressed()){
                if (getTicksSince(uiStateTime) > 100) {
                    pulseLEDColor(0x300, 20, 100);
                    uiState = 1;
                }
            }
            else {
